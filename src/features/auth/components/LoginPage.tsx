...
export function LoginPage() {
  ...
  return (
    <div className="mx-auto flex min-h-dvh w-full max-w-md flex-col justify-center gap-6 px-4 py-8">
      ...
      {/* Redirige a "/" — todavía no hay panel autenticado propio
          (llega en Fase 2). SessionProvider recoge la sesión nueva solo
          con el listener de Supabase; no hace falta pasarle nada aquí. */}
